...
namespace NIRS {
    ...
    struct ProjectionSettings {
        ...
        enum Landmark {
            ...
            // ----------------------------------------------------------------------
            // The 10-5 system fully defines 345 locations for ultra-high-density
            // electrode/optode placement. This enum provides comprehensive coverage
            // of all standard and extended positions for NIRS probe placement
            // aligned with EEG coordinate systems.
            // ----------------------------------------------------------------------
        };
